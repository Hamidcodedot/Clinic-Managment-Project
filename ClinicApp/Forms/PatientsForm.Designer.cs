...
namespace ClinicApp.Forms
{
    partial class PatientsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            var inputPanel = CreateInputSidebar("Patient Details");

            txtName = AddLabeledField(inputPanel, "Name *", 55);
            txtAge = AddLabeledField(inputPanel, "Age", 115);

            inputPanel.Controls.Add(new Label { Text = "Gender", Location = new Point(20, 178), AutoSize = true, ForeColor = Color.FromArgb(127, 140, 141), Font = new Font("Segoe UI", 8.5F) });
            cmbGender = new ComboBox { Location = new Point(20, 196), Width = 230, DropDownStyle = ComboBoxStyle.DropDownList, Font = new Font("Segoe UI", 9.5F) };
            cmbGender.Items.AddRange(new[] { "Male", "Female", "Other" });
            inputPanel.Controls.Add(cmbGender);

            txtPhone = AddLabeledField(inputPanel, "Phone *", 235);
            txtAddress = AddLabeledField(inputPanel, "Address", 295);
            ...
            btnClear.Location = new Point(140, 370);
            ...
            pnlSearch.Controls.Add(new Label { Text = "Search by name or phone", Location = new Point(0, 4), AutoSize = true, ForeColor = Color.FromArgb(127, 140, 141), Font = new Font("Segoe UI", 8.5F) });
            ...
            StyleDataGrid(dgvPatients);

            var buttonPanel = new Panel { Dock = DockStyle.Bottom, Height = 58 };
            var btnEdit = CreateButton("Edit Selected", Color.FromArgb(70, 130, 180), Color.White, new Size(130, 36));
            btnEdit.Location = new Point(0, 12);
            btnEdit.Click += BtnEdit_Click;
            var btnDelete = CreateButton("Delete Selected", Color.FromArgb(231, 76, 60), Color.White, new Size(130, 36));
